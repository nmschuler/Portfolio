...
namespace LibraryItems
{
    public abstract class LibraryItem : IComparable<LibraryItem>
    {
        ...
        //Precondition: none
        //Postcondition: compares title. returns 0 if both null, returns -1 if this is null, returns 1 if the
                    //libitem is null, else returns the compare
        public int CompareTo(LibraryItem libItem)
        {
            if (this == null && libItem == null)
                return 0;
            ...
            return this.Title.CompareTo(libItem.Title);
        }
    }
}
